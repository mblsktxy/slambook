...
int main(int argc, char** argv) {
    ...
    typedef g2o::BlockSolver<g2o::BlockSolverTraits<6,6>> blockSolver; // 6x6 BlockSolver
    unique_ptr<blockSolver::LinearSolverType> linearSolver = 
        g2o::make_unique<g2o::LinearSolverCholmod<blockSolver::PoseMatrixType>>();
