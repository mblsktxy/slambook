...
// void SetMinimizerOptions(shared_ptr<BalBlockSolver>& solver_ptr, const BundleParams& params, g2o::SparseOptimizer* optimizer) {
void SetMinimizerOptions(unique_ptr<BalBlockSolver>& solver_ptr, const BundleParams& params, g2o::SparseOptimizer* optimizer) {
    //cout<<"Set Minimizer  .."<< endl;
    g2o::OptimizationAlgorithmWithHessian* solver;
    if (params.trust_region_strategy == "levenberg_marquardt") {
        // solver = new g2o::OptimizationAlgorithmLevenberg(solver_ptr.get());
        solver = new g2o::OptimizationAlgorithmLevenberg(move(solver_ptr));
    }
    else if (params.trust_region_strategy == "dogleg") {
        // solver = new g2o::OptimizationAlgorithmDogleg(solver_ptr.get());
        solver = new g2o::OptimizationAlgorithmDogleg(move(solver_ptr));
    }
    else {
...
// this function is unused yet..
// void SetLinearSolver(shared_ptr<BalBlockSolver>& solver_ptr, const BundleParams& params) {
void SetLinearSolver(unique_ptr<BalBlockSolver>& solver_ptr, const BundleParams& params) {
    //cout<<"Set Linear Solver .."<< endl;
    // g2o::LinearSolver<BalBlockSolver::PoseMatrixType>* linearSolver = 0;
    unique_ptr<g2o::LinearSolver<BalBlockSolver::PoseMatrixType>> linearSolver = 0;
    ...
    if (params.linear_solver == "dense_schur") {
        ...
        linearSolver = g2o::make_unique<g2o::LinearSolverCholmod<BalBlockSolver::PoseMatrixType>>();        
    ...
    // solver_ptr = make_shared<BalBlockSolver>(linearSolver);
    solver_ptr = g2o::make_unique<BalBlockSolver>(move(linearSolver));
...
void SetSolverOptionsFromFlags(BALProblem* bal_problem, const BundleParams& params, g2o::SparseOptimizer* optimizer) {   
    ...
    unique_ptr<BalBlockSolver> solver_ptr;
    ...
    if (params.linear_solver == "dense_schur") {
        // linearSolver = new g2o::LinearSolverDense<BalBlockSolver::PoseMatrixType>();
        auto linearSolver = g2o::make_unique<g2o::LinearSolverDense<BalBlockSolver::PoseMatrixType>>();
        solver_ptr = g2o::make_unique<BalBlockSolver>(move(linearSolver));   
    } else if (params.linear_solver == "sparse_schur") {
        // linearSolver = new g2o::LinearSolverCholmod<BalBlockSolver::PoseMatrixType>();
